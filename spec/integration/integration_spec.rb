...
RSpec.describe "Transforming and memoizing data" do
  ...
  it "extracts data from the source" do
    expect(results).to contain_exactly(
      {
        ordered_at: Date.new(2022, 1, 1),
        attn: { first_name: "Ali", last_name: "Alison" },
        account: an_object_having_attributes(class: Account, id: 1),
        processed_at: current_time
      },
      {
        ordered_at: Date.new(2022, 1, 2),
        attn: { first_name: "Ben", last_name: "Benson" },
        account: an_object_having_attributes(class: Account, id: 1),
        processed_at: current_time
      },
      {
        ordered_at: Date.new(2022, 1, 3),
        attn: { first_name: "Cam", last_name: "Camson" },
        account: an_object_having_attributes(class: Account, id: 1),
        processed_at: current_time
      },
      {
        ordered_at: Date.new(2022, 1, 3),
        attn: { first_name: "Deb", last_name: "Debson" },
        account: an_object_having_attributes(class: Account, id: 2),
        processed_at: current_time
      },
      {
        ordered_at: Date.new(2022, 1, 5),
        attn: { first_name: "Eli", last_name: "Elison" },
        account: an_object_having_attributes(class: Account, id: 1),
        processed_at: current_time
      },
      {
        ordered_at: Date.new(2022, 1, 7),
        attn: { first_name: "Fry", last_name: "Fryson" },
        account: nil,
        processed_at: current_time
      }
    )
